...
export default function PostEdit({ post }: { post: any }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: '編輯', href: `/admin/posts/${post.id}/edit` },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="編輯文章" />
            <Form method="post" action={`/admin/posts/${post.id}`} encType="multipart/form-data" className="space-y-4">
                {({ errors }) => (
                    <>
                        ...
                        <div className="grid gap-2">
                            ...
                            <textarea id="content" name="content" className="mt-1 block w-full rounded border" defaultValue={post.content} />
                        ...
                        <div className="grid gap-2">
                            ...
                            <textarea id="content_en" name="content_en" className="mt-1 block w-full rounded border" defaultValue={post.content_en} />
